...
typedef struct {
    ...
    /* V3/V5 feedback checksum is firmware-dependent and must not gate parsing. */
    uint8_t feedback_checksum_received;
    bool feedback_checksum_matches_full;
    bool feedback_checksum_matches_legacy;
} motor_telemetry_t;
